...
$(MODULE_TARGET): $(MODULE_BUILD_DEPS) $(TOP)/sysctl/sysctl.c $(TOP)/sysctl/sysctl_drop_caches.c $(TOP)/sysctl/sysctl_swap_reset.c $(TOP)/sysctl/sysctl_monitor_stat.c $(TOP)/sysctl/sysctl_monitor_meminfo.c $(TOP)/sysctl/sysctl_schedstat.c
